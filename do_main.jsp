        ...
        <div class="gadget">
          ...
          <ul class="sb_menu style12">
            <li><a href="do_profile.jsp">My Profile</a></li>
			 <li><a href="do_Upload_Files.jsp">Upload Files</a></li>
			 <li><a href="do_View_Files.jsp">View All Uploaded Files</a></li>
			 
			  <li><a href="O_VerifyBlock.jsp">Verify Block(Integrity Of Cloud Data)</a></li>
