...
<div class="main">
  <div class="header style9">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html" class="style9">A Lightweight Secure Auditing Scheme for Shared Data in Cloud Storage</a></h1>
      </div>
      <div class="menu_nav">
        <ul>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar style9">
        <div class="article">
          <h2 align="center" class="style13"> View Time Delay Results </h2>
		  <p>&nbsp;</p>
		  
		  
		  
		  
<iframe width="600" height="400" src="Results1.jsp"></iframe>
