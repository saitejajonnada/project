...
<head>
<title>Group Member Profile</title>
...
<div class="main">
  <div class="header style9">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html" class="style31">A Lightweight Secure Auditing Scheme for Shared Data in Cloud Storage</a></h1>
      </div>
      <div class="menu_nav">
        <ul>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar style9">
        <div class="article">
          <h2 align="center" class="style13"> Group Member Profile </h2>
		  <p>&nbsp;</p>
...
<table width="576" height="395" border="1.5" align="center"  cellpadding="0" cellspacing="0"  >
            ...
            <%
						...
						try 
						{
						   	String query="select * from d_receiver where name='"+user+"'"; 
					...
					%>
           <tr>
              <td width="200" rowspan="6"><input  name="image" type="image" src="dr_Pic.jsp?id=<%=i%>" style="width:200px; height:200px;" /></td>
            </tr>
...
if(type.equalsIgnoreCase("one"))
		{
		%> <p align="right"><a href="au_all_users.jsp" class="style20"> Back </a></p>
<%
		}
		if(type.equalsIgnoreCase("two"))
		{
		%><p align="right"><a href="au_dec_req.jsp" class="style20">Back</a></p>
<%
		}
		if(type.equalsIgnoreCase("three"))
		{
		%><p align="right"><a href="au_user_sk_req.jsp" class="style12">Back</a></p>
<%
		}
...
%>		  
	  ...
	  <p class="style9">&nbsp;</p>
        <div class="gadget">
          <p class="star style24">TPM Menu</p>
          <div class="clr"></div>
          <ul class="sb_menu">
