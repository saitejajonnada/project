...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1 class="style3">A Lightweight Secure Auditing Scheme for Shared Data in Cloud Storage</h1>
      </div>
      ...
      <div class="mainbar">
        <div class="mainbar">
          <div class="article">
            ...
            <p class="infopost">&nbsp;</p>
            <form id="form" name="form1" method="post" action="U_Download_Req1.jsp">
              <a href="U_DownPerRes.jsp"> View Download Permission Response </a>
              <p>&nbsp;</p>
              <div align="center">
                <p align="left" class="style17"><strong>Enter Owner Name :</strong>&nbsp;
                    <input name="t142" type="text" size="30" />
                </p>
                <p align="left" class="style17"> <strong>Enter File Name :</strong>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
