<title>Bob Registration authen</title>
...
<%
					...
					try {
						...
						//image = image.replace(".", "_b.");
			 			String query1="select * from d_owners  where name='"+uname+"'"; 
					...
					if ( rs1.next() )
					   {
								...
								out.println("Alice Name Already Exits");							
							%>
							<p><a href="do_Register.jsp">Back</a>         <a href="index.html">Home</a> </p>
			...
			h1 = bi1.toString(16);
					   ...
					   PreparedStatement ps=connection.prepareStatement("insert into d_owners(name,pass,ugroup,email,mobile,addr,dob,gender,pin,location,imagess,status,gkey) values(?,?,?,?,?,?,?,?,?,?,?,?,?)");
