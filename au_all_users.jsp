...
<div class="main">
  <div class="header style9">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html" class="style22">A Lightweight Secure Auditing Scheme for Shared Data in Cloud Storage</a></h1>
      </div>
      <div class="menu_nav">
        <ul>
          <li><a href="index.html">Home Page</a></li>
          <li><a href="cs_login.jsp">Cloud</a></li>
          <li class="active"><a href="au_login.jsp">TPM</a></li>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar style9">
        <div class="article">
          <h2 align="center" class="style15"> View All Group Members and Authorize </h2>
		  <p>&nbsp;</p>
...
<table width="610" border="1.5" cellpadding="0" cellspacing="0" align="center">
         <tr bgcolor="#00FF33">
		   ...
		   <td width="127" bgcolor="#CCCC00"><div align="center" class="style10 style8 style14 style15 style9 style16 style17 style18">User Image</div></td>
           <td width="129" bgcolor="#CCCC00"><div align="center" class="style10 style8 style14 style15 style9 style16 style17 style18">User Name</div></td>
...
<%	  
 ...
 try 
	{		
      	                    String query="select * from d_receiver "; 
		...
		%>
                    ...
                    <tr>
                      ...
                      <td bgcolor="#CC6600" align="center"><input  name="image" type="image" style="width:100px; height:90px;" src="dr_Pic.jsp?id=<%=i%>" /></td>
					  <td bgcolor="#CC6600"><div align="center" class="style10 style11 style8 style13 style14 style16 style17 style19"><%=s2%></div></td>
					  <td width="138" align="center" bgcolor="#CC6600"><a href="au_dr_profile.jsp?user=<%=s2%>&type=<%="one"%>" class="style10 style11 style8 style13 style14 style16 style17 style19">Click here</a></td>
					  <%
              ...
              <td bgcolor="#CC6600"><div align="center" class="style10 style11 style8 style13 style14 style16 style17 style19">
                <a href="au_dr_Status.jsp?id=<%=i%>">waiting</a> </div></td>
              <%
						}
						else
						{
...
%>
	  ...
	  <p class="style9">&nbsp;</p>
        <div class="gadget">
          <p class="star style14 style21">TPM Menu</p>
          <div class="clr"></div>
          <ul class="sb_menu">
            <li><a href="au_main.jsp">TPM Main</a></li>
