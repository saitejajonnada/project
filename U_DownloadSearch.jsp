...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1 class="style3 style28">A Lightweight Secure Auditing Scheme for Shared Data in Cloud Storage</h1>
      </div>
        ...
        <div class="mainbar">
          <div class="article">
	   	...
	   	%>
            ...
            <form action="U_Download1.jsp" method="post" id="form1">
              <table width="473" border="0" align="center">
                <tr>
                  <td width="223" bgcolor="#FF0000"><span class="style18 style29"><strong>Enter File Name :-</strong></span></td>
                  <td width="245"><label>
                    <input required="required" name="t1" type="text" value="<%=fname%>" size="40" />
                  </label></td>
                </tr>
                <tr>
                  <td height="34" bgcolor="#FF0000"><span class="style29 style18"><strong>Signature :-</strong></span></td>
