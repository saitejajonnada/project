...
if(type.equalsIgnoreCase("one"))
		{
		%> <p align="right"><a href="cs_all_do_files.jsp" class="style20"> Back </a></p>
<%
		}
		if(type.equalsIgnoreCase("two"))
		{
		%><p align="right"><a href="cs_do_enc_req.jsp" class="style20">Back</a></p>
<%
		}
		if(type.equalsIgnoreCase("three"))
		{
		%><p align="right"><a href="cs_do_sk_req.jsp" class="style12">Back</a></p>
<%
		}
		if(type.equalsIgnoreCase("four"))
		{
		 
		%><p align="right"><a href="css.jsp" class="style12">Back</a></p>
<%
		}
...
%>		  
	  ...
	  <p class="style9">&nbsp;</p>
        <div class="gadget">
          <p class="star style24">Server Menu</p>
          <div class="clr"></div>
          <ul class="sb_menu">
