					...
					if ( rs1.next() )
					   {
							...
							%>
							<p><a href="dr_register.jsp">Back</a>         </p>
					   ...
					   {
					String str="waiting";
					PreparedStatement ps=connection.prepareStatement("insert into d_receiver(name,pass,email,mobile,addr,dob,gender,pin,location,image,status,category) values(?,?,?,?,?,?,?,?,?,?,?,?)");
						...
						if(x>0){
													...
													out.println("Sucessfully Registered as Group Member ");							
