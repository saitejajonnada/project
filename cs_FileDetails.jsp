...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1 class="style3 style26">A Lightweight Secure Auditing Scheme for Shared Data in Cloud Storage</h1>
      </div>
					...
					if(s6.equalsIgnoreCase("Shared"))
					{
						...
						String fn = new String(Base64.decode(s5.getBytes()));
							...
							if ( rs1.next())
							{
								...
								<tr>
								<td height="30" bgcolor="#FF0000"><div align="center" class="style27"><strong>Secret Key : </strong></div></td>
								<td><div align="center">
...
%>
            ...
            <p>&nbsp; </p>
            <p align="right"><a href="cs_View_Files.jsp">Back</a></p>
          <div class="style2"></div>
          <div class="img">
