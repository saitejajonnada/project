...
var na91=document.s.cat.value;
if(na91=="-------------Select-------------")

{
alert("Please Select Your Category");
document.s.cat.focus();
return false;
}
...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html" class="style14">A Lightweight Secure Auditing Scheme for Shared Data in Cloud Storage</a></h1>
      </div>
      <div class="menu_nav">
        <ul>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center"> Group Member Registration </h2>
          <p>&nbsp;</p>
...
<form action="URegister.jsp" method="post" id="" enctype="multipart/form-data">
            ...
            <br />
              <span class="style4 style10">User Name (required)<br />
            </span></label>
            <p class="style4 style10">
              <input id="name" name="userid" class="text" />
            </p>
            <span class="style4 style10">
            ...
            <p class="style4 style10">Select Your Group<br />
               <select name="grp">
...
<p>&nbsp;</p>
<p align="right"><a href="dr_login.jsp" class="style13 style9"> Back </a></p>
